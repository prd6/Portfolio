...
```bash
git clone https://github.com/prd6/portfolio.git
```
...
- 📧 Email: prd6.itex.neo@gmail.com
- 💼 LinkedIn: https://www.linkedin.com/in/priyangshu-das-301b4639a

## ❤️ Credits

UI animations and components inspired by and built with **React Bits**.
